      ...
      <div class="modal-content">
        ...
        <div class="container">
		    <div class="row lead">
		        ...
		        <input min="0" max="5" id ="star-rating" type="number"></input>
...
<?php 
	...
	$sql = "CALL Display_contents_of_Album('".$Album_id."')";
   ...
   <th ALIGN = 'Center'>LISTEN</th>
		...
		echo "NO TRACKS INCLUDED IN THE ALBUM";
	}
...
function Spotfiy(Track_ID,Track_title) {     
    ...
    $.post('insert_into_play.php',{postTrack_ID:Track_ID1,postUsername:User, Source: 'Album', Source_id: '<?php echo $Album_id?>'},
    function(data)
    {
    $('#result').html(data);    
    });
